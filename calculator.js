...
const calculate = () => {
  ...
  try {
    // 디버깅을 위한 현재 상태 출력
    console.log("계산 시작:", { firstNumber, operator, currentInput });
    ...
    console.log("변환된 숫자:", { firstNumber, secondNumber, operator });
    ...
    // result가 정의되지 않았거나 유효하지 않은 경우 확인
    if (result === undefined || isNaN(result)) {
      throw new Error("계산 결과를 생성할 수 없습니다.");
    }
